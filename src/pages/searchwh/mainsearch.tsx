      ...
      <div className="main-search">
        ...
        <div className="main-search-container">
          <div className="main-search-doctors-container">
            <img src="https://www.aetna.com/content/dam/aetna/asset-libraries/photos/AdobeStock_271211103_696x522.jpg" alt="Care Now" />
          ...
          <div className="main-search-providers-container">
            ...
            <img src="https://cdn.iuhealth.org/callouts/get-care-now_callout.jpg" alt="Health Plans" />
          </div>
        </div>
        <Routes>
